...
int main(void)
{
  ...
  HAL_TIM_PWM_Start(&htim1, TIM_CHANNEL_2);	//start		BRF
  //tim15
  HAL_TIM_PWM_Start(&htim15, TIM_CHANNEL_1);//start		MRS
  HAL_TIM_PWM_Start(&htim15, TIM_CHANNEL_2);//start		MRF
  //tim2
  HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_1);//start		BLF
  HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_2);//start		BLS
  HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_3);//start		MLF
  HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_4);//start		MLS
  //tim3
  HAL_TIM_PWM_Start(&htim3, TIM_CHANNEL_1);//start		TLF
  HAL_TIM_PWM_Start(&htim3, TIM_CHANNEL_2);//start		TLS
  HAL_TIM_PWM_Start(&htim3, TIM_CHANNEL_3);//start		TRS
  HAL_TIM_PWM_Start(&htim3, TIM_CHANNEL_4);//start		TRF
  /* USER CODE END 2 */
